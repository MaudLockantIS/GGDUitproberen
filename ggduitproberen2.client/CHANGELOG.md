...
- Create Angular project with ng: `ng new ggduitproberen2.client --defaults --skip-install --skip-git --no-standalone `.
...
- Create project file (`ggduitproberen2.client.esproj`).
